...
type PowerConsumptionDetail struct {
	AvgPwr     int   `json:"avgPwr"`
	MaxPwr     int   `json:"maxPwr"`
	MaxPwrTime int64 `json:"maxPwrTime"`
	MinPwr     int   `json:"minPwr"`
	MinPwrTime int64 `json:"minPwrTime"`
}
...
type AvgPowerConsumptionStatDataObjEventData struct {
	...
	Min                  PowerConsumptionDetail `json:"Min"`
	Hour                 PowerConsumptionDetail `json:"Hour"`
	Day                  PowerConsumptionDetail `json:"Day"`
	Week                 PowerConsumptionDetail `json:"Week"`
}
