				...
				"Oem": map[string]interface{}{ //Done
					"Dell": map[string]interface{}{
						"DellController": map[string]interface{}{
							...
							"DeviceCardSlotType@meta":        v.Meta(view.PropGET("device_card_slot_type")),
							"DriverVersion@meta":             v.Meta(view.PropGET("driver_version")),
							"EncryptionCapability@meta":      v.Meta(view.PropGET("encryption_capability")),
							"EncryptionMode@meta":            v.Meta(view.PropGET("encryption_mode")),
							"PCISlot@meta":                   v.Meta(view.PropGET("pci_slot")),
							"PatrolReadState@meta":           v.Meta(view.PropGET("patrol_read_state")),
							"RollupStatus@meta":              v.Meta(view.PropGET("rollup_status")),
							"SecurityStatus@meta":            v.Meta(view.PropGET("security_status")),
							"SlicedVDCapability@meta":        v.Meta(view.PropGET("sliced_vd_capabiltiy")),
						},
					},
				},
