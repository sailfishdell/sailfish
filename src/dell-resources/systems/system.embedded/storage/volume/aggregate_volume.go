				...
				"Oem": map[string]interface{}{ //Done
					"Dell": map[string]interface{}{
						"DellVirtualDisk": map[string]interface{}{
							...
							"BusProtocol@meta":         v.Meta(view.PropGET("bus_protocol")),
							"Cachecade@meta":           v.Meta(view.PropGET("cache_cade")),
							"DiskCachePolicy@meta":     v.Meta(view.PropGET("disk_cache_policy")),
							"LockStatus@meta":          v.Meta(view.PropGET("lock_status")),
							"MediaType@meta":           v.Meta(view.PropGET("media_type")),
							"ReadCachePolicy@meta":     v.Meta(view.PropGET("read_cache_policy")),
							"SpanDepth@meta":           v.Meta(view.PropGET("span_depth")),
							"SpanLength@meta":          v.Meta(view.PropGET("span_length")),
							"VirtualDiskTargetID@meta": v.Meta(view.PropGET("virtual_disk_target")),
							"WriteCachePolicy@meta":    v.Meta(view.PropGET("write_cache_policy")),
						},
					},
				},
