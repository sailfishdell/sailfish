...
func (s *loggingService) ResourceHandler(ctx context.Context, r *http.Request, privileges []string) (resp *Response, err error) {
	...
	return s.Service.ResourceHandler(WithLogger(ctx, ctxlogger), r, privileges)
}
